...
- **Re-checked during implementation** at `d2f7e31` (end of task group 3) `389317a` (end of task group 4) and `22839cd` (end of task group 6). The intervening
