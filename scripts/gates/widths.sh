...
# WIDTHS_MIN's default moves, 57 -> 72 -> 101 -> 113 -> 114 (view-fidelity, then
# markdown-constructs' one added view test, per design.md -> Decision 4 and
# markdown-constructs' Decision 11: gate floors move up, because they are floors).
#
...
WIDTHS_MIN="${WIDTHS_MIN:-114}" python3 - <<'PY'
import re, sys, os
